...
type UnknownToolLoopGuardState = {
  ...
  /**
   * Most-recent exhaustion event surfaced to external observers (e.g. the
   * embedded run loop) so cron can fail closed instead of delivering the
   * injected self-debug text as a normal assistant reply.
   */
